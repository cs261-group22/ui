<template>
  <div class="fixed z-10 inset-0 overflow-y-auto">
    <div
      class="flex items-center sm:items-end justify-center min-h-screen pt-6 px-8 pb-20 text-center sm:block sm:p-0"
    >
      ...
      >
        <div class="bg-white px-6 pt-4 pb-4 sm:p-8 sm:pb-6">
